...
import {faBars, faHome,faEnvelope,faBookOpen,faCode,faFolder,faComment,faPowerOff, faAd, faUserCheck, faUserEdit, faReply} from "@fortawesome/free-solid-svg-icons";
